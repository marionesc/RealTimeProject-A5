...
STKPTR=2;fptr=&tache1; val_tos=(unsigned short int) fptr; puc=(unsigned char *)&val_tos; TOSL=*puc;puc++; TOSH=*puc;puc++; TOSU=*puc;
STKPTR=7;fptr=&tache2; val_tos=(unsigned short int) fptr; puc=(unsigned char *)&val_tos; TOSL=*puc;puc++; TOSH=*puc;puc++; TOSU=*puc;
STKPTR=12;fptr=&tache3; val_tos=(unsigned short int) fptr; puc=(unsigned char *)&val_tos; TOSL=*puc;puc++; TOSH=*puc;puc++; TOSU=*puc;
STKPTR=17;fptr=&tache4; val_tos=(unsigned short int) fptr; puc=(unsigned char *)&val_tos; TOSL=*puc;puc++; TOSH=*puc;puc++; TOSU=*puc;
STKPTR=22;fptr=&tache5; val_tos=(unsigned short int) fptr; puc=(unsigned char *)&val_tos; TOSL=*puc;puc++; TOSH=*puc;puc++; TOSU=*puc;
STKPTR=27;fptr=&tache6; val_tos=(unsigned short int) fptr; puc=(unsigned char *)&val_tos; TOSL=*puc;puc++; TOSH=*puc;puc++; TOSU=*puc;
